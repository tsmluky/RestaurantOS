...
class ShiftStatus(StrEnum):
    DRAFT = "DRAFT"          # Created by manager, not yet visible to employees
    PUBLISHED = "PUBLISHED"  # Published — employees notified, visible in app
    SCHEDULED = "SCHEDULED"  # Legacy alias (= PUBLISHED), kept for backwards compat
    CANCELLED = "CANCELLED"
