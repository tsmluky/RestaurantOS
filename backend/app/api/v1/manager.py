    ...
    *,
    ...
    if approved:
        return send_push(
            ...
            data={"type": "correction_approved", "target_id": str(target_id)},
        )
    return send_push(
        db,
        user_ids=[user_id],
        ...
        data={"type": "correction_rejected", "target_id": str(target_id)},
    )
...
def update_incident(
    ...
    if payload.status in {
        ...
        _notify_correction_result(
            ...
            approved=payload.status != IncidentStatus.REJECTED,
            target_id=incident.id,
        )
    return incident
